    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="gray-600 mb-4">Be the first to har about new products, exlusive events and online offers</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>
              <Link to="" className="hover:text-gray-500 transition-colors">Anout</Link>
            </li>
            <li>
